...
format:
  revealjs:
    slide-number: c/t
    theme: default #dark
    footer: "Ingresso no mercado de trabalho - SEMANA ACADÊMICA UFSM - [Vítor Pereira](https://github.com/VitorBSP)"
...
### Motivá-los com o mercado e o futuro para estatístico (cientista de dadods)
...
![Uma nova Parceria: HartB é a uma Start up do Sistema Google](images/google.png){fig-align="center" width="1000"}
...
![](images/rmarkdown.png){fig-align="left" width="200" height= "300"}
![](images/latex.png){fig-align="center" width="200" height= "300"}
![](images/git.png){fig-align="right" width="300" height= "300"}

## Pilar 3 

- Outros 2 naturalmente ajudam com o 3;
...
- [Análise Exploratória em Python com Jodavid](https://www.youtube.com/watch?v=GK-7lGI9Sqk)

<p>

- [Primeiros passos com R Markdown com Thiago](https://www.youtube.com/watch?v=vdV1xHiwirI&t=86s)

<p>

- [Noções de SQL e Tidyverse com Cátia e Magno](https://www.youtube.com/watch?v=vdV1xHiwirI&t=86s)

<p>

- [Introdução ao Aprendizado de Máquina com Douglas](https://colab.research.google.com/drive/1zwCMjGg5j5HqkwtIODuuLYerC3sAVpnV?usp=sharing)

<p>

- [Introdução ao PySpark com Jonatas](https://www.youtube.com/watch?v=1-DZKTFK1EE)
